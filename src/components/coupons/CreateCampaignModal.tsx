                ...
                <div className="w-full pr-8 sm:pr-0">
                  <div className="mb-6 sm:mb-8">
                    ...
                    <p className="mt-1.5 text-xs text-gray-500 sm:text-sm">
                      Fill in the details below to create a new coupon campaign
                    </p>
                  </div>
                    ...
                    <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 sm:gap-6">
                      <div>
                        ...
                        <input
                          ...
                          onChange={(e) => {
                            ...
                            setFormData(prev => ({ ...prev, number_of_coupons: isNaN(val) ? 1 : val }));
                          }}
                      ...
                      <div>
                        ...
                        <input
                          ...
                          onChange={(e) => setFormData(prev => ({ ...prev, code_prefix: e.target.value.toUpperCase().replace(/\s/g, '') }))}
                          className="block w-full rounded-lg border border-gray-200 bg-white px-3 py-2 text-sm text-gray-900 placeholder-gray-400 focus:border-gray-400 focus:outline-none focus:ring-0 transition-colors sm:px-4 sm:py-2.5"
                          placeholder="PREFIX"
                        />
                      </div>
                    ...
                    <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 sm:gap-6">
                      <div>
                        ...
                        <input
                          ...
                          onChange={(e) => {
                            const val = e.target.value === '' ? 1 : parseInt(e.target.value);
                            setFormData(prev => ({ ...prev, usage_limit: isNaN(val) ? 1 : val }));
                          }}
                          onWheel={(e) => e.currentTarget.blur()}
                          className="block w-full rounded-lg border border-gray-200 bg-white px-3 py-2 text-sm text-gray-900 placeholder-gray-400 focus:border-gray-400 focus:outline-none focus:ring-0 transition-colors sm:px-4 sm:py-2.5"
                          placeholder="1"
                      ...
                      <div>
                        ...
                        <input
                          ...
                          onChange={(e) => setFormData(prev => ({ ...prev, image_url: e.target.value || undefined }))}
                          className="block w-full rounded-lg border border-gray-200 bg-white px-3 py-2 text-sm text-gray-900 placeholder-gray-400 focus:border-gray-400 focus:outline-none focus:ring-0 transition-colors sm:px-4 sm:py-2.5"
                    ...
                    <div className="pt-2">
                      <div className="flex items-start sm:items-center">
                        ...
                        <label htmlFor="public" className="ml-2.5 block text-xs font-medium text-gray-700 cursor-pointer leading-relaxed sm:ml-3 sm:text-sm">
                          Make coupons publicly available
                        </label>
                      </div>
                    </div>
